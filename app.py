...
COL = {
    ...
    "qte_vendues":["Qté totales vendues","Qte totales vendues"],
    "stock_brut":["Qté Livr/Aff Ligne","Qte Livr/Aff Ligne","Stock","Qté dispo","Qte dispo"],
...
def do_import(uf,mode):
    ...
    for _,row in df.iterrows():
        ...
        for k in COL:
            ...
            if k in ("stock_brut","qte_commandee","qte_vendues"): r[k]=si(val)
